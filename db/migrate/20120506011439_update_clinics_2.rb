class UpdateClinics2 < ActiveRecord::Migration
  def self.up
      drop_table :clinics
       create_table :clinics do |t|
          ...
          t.boolean :is_individual # not sure why this is relevant, but.  
          t.string :street
          t.string :street2
          t.string :city
          t.string :state
