class UpdateUsersDrop3fields < ActiveRecord::Migration
   def self.up
         drop_table(:users) 
         create_table(:users) do |t|
           ...
           t.string  :role # at clinic: owner, administrator, clinician, ... Redundant with 'type'. Drop 
           ...
           t.string :address # of patient, if patient, of clinic if clinician or clinic administrator
           t.string :address2
           t.string :city
           t.string :state
           t.string :zip
           ...
           t.integer :wants_n_catelogs # if rep or dealer? 
