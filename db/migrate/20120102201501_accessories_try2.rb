class AccessoriesTry2 < ActiveRecord::Migration
  def self.up
     ...
     create_table :accessories do |t|
              ...
              t.integer  "accessory_for"     # unused, here or in products; forgot it was there and added another field 'accessory_of-id' above ) 
