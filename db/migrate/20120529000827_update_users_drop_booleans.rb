class UpdateUsersDropBooleans < ActiveRecord::Migration
  ...
  def self.up
       ...
       create_table(:users) do |t|
         ...
         t.integer :owner # redundant with role value; 0 = no ; 1=yes
         t.integer :administrator # redundant with role value "administrator"
         t.integer :clinician # redundant with role vlaue "clinician" or are all owners and administrators also considered clinicians?  ie they get the clinician pricing, for now, yes #14
