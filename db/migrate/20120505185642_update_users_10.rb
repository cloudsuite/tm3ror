class UpdateUsers10 < ActiveRecord::Migration
  def self.up
     drop_table(:users) 
         create_table(:users) do |t|
            ...
            t.boolean :clinician # redundant with role vlaue "clinician" or are all owners and administrators also considered clinicians?  ie they get the clinician pricing, for now, yes
            t.string :password
